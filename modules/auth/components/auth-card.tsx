...
export default function AuthCard({ children }: { children: React.ReactNode }) {
	return (
		<div className='flex flex-col gap-4 items-center justify-center min-h-screen absolute inset-0 bg-linear-to-br from-brand-primary/10 via-brand-secondary/5 to-transparent animate-gradient-xy'>
