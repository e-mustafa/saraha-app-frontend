...
function TooltipContent({
	...
	return (
		<TooltipPrimitive.Portal>
			...
			>
				{children}
				<TooltipPrimitive.Arrow className='z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-card-glass backdrop-blur-2xl fill-card-glass border-b border-s mt-0.5 border-brand-secondary/30' />
			</TooltipPrimitive.Content>
		</TooltipPrimitive.Portal>
	);
}
